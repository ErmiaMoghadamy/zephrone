...
pub const Texture = struct {
    ...
    pub fn init(io: std.Io, allocator: std.mem.Allocator, filepath: []const u8, ts: i32) !Texture {
        var t = Texture{
            .id = 0,
            .allocator = allocator,
    ...
    pub fn post_init(self: *Texture, io: std.Io) !void {
        // load image cpu buffer

        const img = try Texture.loadPngRgba8(io, self.allocator, self.filepath);
    ...
    pub fn loadPngRgba8(io: std.Io, allocator: std.mem.Allocator, path: []const u8) !RgbaImage {
